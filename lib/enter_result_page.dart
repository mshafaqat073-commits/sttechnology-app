...
class EnterResultPage extends StatefulWidget {
  const EnterResultPage({super.key});

  @override
  State<EnterResultPage> createState() => _EnterResultPageState();
}
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("Class: $_className | Section: ${_section.isEmpty ? 'N/A' : _section} | Roll No: $_rollNo"),
                    ],
                  ),
                ),
